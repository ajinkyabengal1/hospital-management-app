          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              <figure className="max-w-[200px] max-h-[200px]">
                <img src={doctorImg} alt="Loading" className="w-full" />
              </figure>
              ...
              <div>
                ...
                <h3 className="text-headingColor text-[22px] leading-7 mt-3 font-bold">
                  Amit Shah
                </h3>
                ...
                <p className="text_para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px]">
                  ...
                  Dolorum consequatur veritatis cumque, aspernatur est quos
                </p>
              </div>
            </div>
